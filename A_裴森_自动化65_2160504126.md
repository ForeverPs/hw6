...
&ensp;&ensp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq1.gif /> <br><br>
&emsp;其中，上式中的`z`代表灰度值，`p(z)`代表灰度值出现的概率密度。在产生高斯噪声的时候需要指定两个参数的数值，分别是灰度值的均值<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq2.gif />与灰度值分布的标准差<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq3.gif />。在一般情况下，均值都选择为`0`。标准差越大，高斯噪声的灰度值离散情况越严重，分布越不均匀，对图像的影响也就越大。例如对`lena.bmp`都采用均值为`0`的高斯噪声，但是指定不同的标准差<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq3.gif />，可以得到以下一系列对比图像：<br>
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\n_gau.png width=650 height=340 /><br> 
**<center>图片1.高斯噪声</center>**<br>
&emsp;从图片1可以看出，在均值相同的情况下，<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq3.gif />越大，高斯噪声越明显。当<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq3.gif />=0并且均值也为0时，就是原图，也就是图片1中的第一幅图像。<br>
#### 椒盐噪声
...
&ensp;&ensp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq4.gif /> <br><br>
&emsp;上式中，`a`代表椒噪声，即黑色点；`b`代表盐噪声，即白色点。<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq5.gif /> 分别代表椒噪声与盐噪声出现的概率，这两个参数需要指定。另外注意一点，椒盐噪声并不是通常的加性噪声，也就是说，它不能像高斯噪声那样产生一系列灰度值，然后与原图做加法，这显然是不合理的。我所采用的处理方式是：<br>
* 随机生成一系列分布在`0-1`之间的数字，数字的数目与图片像素数相同。
* 以交互方式得到用户指定的<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq5.gif />
* 如果随机数小于<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq6.gif />，则把图像中对应位置的像素值置为`0`，代表椒噪声。
* 如果随机数大于<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq7.gif />，则把图像中对应位置的像素值置为`255`，代表盐噪声。
* 其他位置的像素值不做改动。<br>

&emsp;上面所说的处理方式保证了椒噪声与盐噪声是按照指定的概率分布的，以`lena.bmp`图像为例，分别对她添加盐噪声，椒噪声以及椒盐噪声，得到图片2中的结果：<br>
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\n_ps.png width=650 height=220 /><br> 
...
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq8.gif /><br>
* 几何均值滤波器-----Geometric mean filter<br><br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq9.gif /><br>
* 中值滤波器-----Median filter<br><br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq10.gif /><br>

&emsp;上述三个滤波器中，<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq11.gif /> 均代表根据噪声图像恢复后的原始图像的一个近似，可以看出，算术均值滤波器就是在给定的窗口大小范围内计算像素的平均值；几何均值滤波器是在滤波窗口内计算所有像素的几何均值；中值滤波器是一种常用的排序滤波器，它可以得到滤波范围内像素的中位数。<br>
&emsp;以高斯噪声为例，选取均值<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq2.gif />=0，标准差<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq3.gif />=20的高斯噪声加入到原始图像`lena.bmp`中，分别用上述三种滤波器进行滤波，设置的窗口大小均为`3x3`，得到结果如图片3所示：<br><br>
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\m_f.png width=500 height=400 /><br> 
...
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\m_p.png width=530 height=400 /><br> 
...
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\ps.png width=510 height=400 /><br> 
...
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\chf.png width=680 height=220 /><br> 
...
<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq15.gif /><br><br>
...
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\sb.png width=600 height=430 /><br> 
...
&emsp;首先声明几个符号：<br>
* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq17.gif />&emsp;：原始图像(未退化)的傅里叶变换<br>
* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq16.gif />&emsp;：经维纳滤波器复原后图像的傅里叶变换<br>
* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq18.gif />&ensp;：退化函数傅里叶变换<br>
* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq19.gif />：维纳滤波器的频域表达式<br>
* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq20.gif />&ensp;：加性噪声的傅里叶变换<br>
* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq22.gif />&ensp;：被噪声污染后的图像<br>
* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq21.gif />&emsp;：误差<br>

&emsp;它们之间的关系可以用如下的框图表示：<br>
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\hand.jpg width=600 height=260 /><br> 
**<center>图片8.频域关系框图</center>**<br>
&emsp;根据图片8，可以得到上述变量在频域中的关系(下面设计的乘法均是对应相乘)：<br>
* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq23.gif /><br>

* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq24.gif /><br>

* <img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq25.gif /><br>

&emsp;维纳滤波器所采用的代价函数是均方误差的期望值，因为仅仅有维纳滤波器`Hw`为变量，因此，代价函数必然是`Hw`的函数，这可以写成以下形式：<br><br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq26.gif /><br><br>
&emsp;为了方便推导，由于元素之间是对应相加与相乘，这相当于以为函数，因此用之前定义的变量代表一个标量值，它是傅里叶变换后，矩阵中的某个位置的数值。展开代价函数，并进行化简，可以得到以下过程：<br><br>
&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq29.gif /><br>
<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq27.gif /><br>
<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq28.gif /><br>
<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq30.gif /><br><br>
&emsp;用代价函数对维纳滤波器求偏导数，极小值的必要条件是偏导数为0，从而，可以得到维纳滤波器的频域表达式(变量的共轭与变量是不同的，不需要考虑它们之间的函数关系)：<br><br>
<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq31.gif /><br><br>
&emsp;从而解得维纳滤波器的频域表达式为：<br><br>
<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq32.gif /><br><br>
...
&emsp;&emsp;<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\wiener.png width=600 height=300 /><br> 
...
<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq33.gif /><br><br>
&emsp;从维纳滤波器的表达式可以看出，退化函数在与不同的`K`值配合下所得到的滤波结果差异是非常大的，这说明退化函数`H`对`K`值十分敏感。而最小二乘方的思想就是减小`H`对噪声的敏感性，因此，它定义了如下形式的损失函数：<br><br>
<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq34.gif /><br><br>
&emsp;仍然采用偏导数为`0`的方法，可以得到约束最小二乘方滤波器的频域表达式为：<br><br>
<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq35.gif /><br><br>
&emsp;上式中的`P`代表的是`Laplace`算子的傅里叶变换，这里仅有参数<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq36.gif />是需要估计的变量。并且，由于<img src= C:\Users\peisen\Desktop\数字图像处理\第6次作业\eq36.gif />的单调性，使得估计有了方向性。估计的原则如下：<br><br>
